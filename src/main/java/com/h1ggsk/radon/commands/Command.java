package com.h1ggsk.radon.commands;
...
import com.h1ggsk.radon.utils.TextUtils;
...
public abstract class Command {
    ...
    protected static final MinecraftClient mc = Radon.mc;
    protected static final ModuleManager moduleManager = Radon.INSTANCE.getModuleManager();
    ...
    public Command(String name, String description, String... aliases) {
        this.name = name;
        this.title = TextUtils.nameToTitle(name);
    ...
    public void info(String message) {
        mc.player.sendMessage(Text.of(title + ": " + message), false);
    }
}