...
public final class HUD extends Module {
    private static final CharSequence watermarkText = EncryptedString.of("Radon Client");
    ...
    public void onRender2D(Render2DEvent render2DEvent) {
        if (mc.currentScreen != Radon.INSTANCE.GUI) {
    ...
    private List<Module> getSortedModules() {
        List<Module> list = Radon.INSTANCE.getModuleManager().getEnabledModules();
