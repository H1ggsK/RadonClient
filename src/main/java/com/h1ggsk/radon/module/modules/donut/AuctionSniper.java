...
import com.h1ggsk.radon.module.setting.*;
...
public final class AuctionSniper
    ...
    public void onTick(StartTickEvent startTickEvent) {
        block10: {
            block9: {
                ...
                if (!(mc.player.currentScreenHandler instanceof GenericContainerScreenHandler)) break block10;
        ...
        mc.getNetworkHandler().sendChatCommand("ah " + string3);
                ...
                block8: {
                    block11: {
                        block9: {
                            ...
                            ScreenHandler screenHandler = mc.player.currentScreenHandler;
                            if (!(mc.player.currentScreenHandler instanceof GenericContainerScreenHandler)) break block9;
    ...
    private boolean isValidAuctionItem(ItemStack itemStack) {
        List list = itemStack.getTooltip(Item.TooltipContext.DEFAULT, mc.player, TooltipType.BASIC);
